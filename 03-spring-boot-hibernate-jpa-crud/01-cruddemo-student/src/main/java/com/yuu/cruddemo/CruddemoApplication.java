...
import com.yuu.cruddemo.dao.StudentDAO;
...
public class CruddemoApplication {
	...
	private void deleteAllStudents(StudentDAO studentDAO) {
		...
		System.out.println("Retrieve row count: " + numRowsDeleted);
	}
	...
	private void createMultipleStudents(StudentDAO studentDAO) {
		...
		Student tempStudent3 = new Student("Bonita", "Private", "bonitaprivate@gmail.com");
